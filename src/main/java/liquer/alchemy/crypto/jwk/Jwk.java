...
import static liquer.alchemy.crypto.jwk.JwkParameter.*;
...
public final class Jwk extends TypedMap {
	...
	public Jwk(SignatureAlgorithms signatureAlgorithm, Key key)  {
		this();
...
//					ECPublicKey publicKeyGenerated = (ECPublicKey) keyFactory.generatePublic(pubSpec);
	...
	public SignatureAlgorithms getAlgorithm() {
		return enumValue(SignatureAlgorithms.class, alg, null);
	}

	public void setAlgorithm(SignatureAlgorithms SignatureAlgorithm) {
