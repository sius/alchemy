...
public class CanonicalRequest {
	...
	public CanonicalRequest(URI uri, CanonicalHeaders canonicalHeaders, String algorithm, String payload, String method, boolean unsigned) {
		...
		this.algorithm = (Pedantic.isNullEmptyOrBlank(algorithm) ? "SHA-256" : algorithm).toUpperCase();
	...
	@Override public String toString() {
        return
            ...
            (unsigned ? requestPayload : Pedantic.hexEncode(CryptoLimericks.hash(requestPayload, algorithm, false)));
	}
}
