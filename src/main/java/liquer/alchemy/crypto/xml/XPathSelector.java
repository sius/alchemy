...
import liquer.alchemy.fun.Func.Func3;
import liquer.alchemy.fun.Func.Func2;
...
public class XPathSelector {
    private static final Logger LOG = LogManager.getLogger(XPathSelector.class);
    ...
    public static Func2<Node, String, Stream<Node>> getSelectStreamClosure(NamespaceContext namespaceContext) {
        Func3<NamespaceContext, Node, String, Stream<Node>> ret = (nsCtx, doc, str) -> XmlUtil.toStream(select(doc, str, nsCtx));
        return ret.apply(namespaceContext);
    }
