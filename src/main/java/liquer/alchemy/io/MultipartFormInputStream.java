...
public final class MultipartFormInputStream {
	 ...
	 */
	public final static String HEADER_DELIMITER = Pedantic.decodeBytesToString(HEADER_SEPARATOR, Charset.defaultCharset());
	 ...
	 */
	public final static String FIELD_DELIMITER = Pedantic.decodeBytesToString(HEADER_SEPARATOR, Charset.defaultCharset());
	...
	public String readHeaders(final int maxSize) throws MalformedStreamException {
		...
		if (headerEncoding == null) {
			headers = Pedantic.decodeBytesToString(baos.toByteArray(), Charset.defaultCharset());
		} else {
			headers = Pedantic.decodeBytesToString(baos.toByteArray(), headerEncoding);
		}
	...
	public String readBodyDataToString(String charsetName) throws IOException {
		...
		readBodyData(ret);
		return Pedantic.decodeBytesToString(ret.toByteArray(), charsetName);
	}
	/**
	 * <p>
