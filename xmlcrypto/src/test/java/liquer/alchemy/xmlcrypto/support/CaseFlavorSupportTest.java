...
class CaseFlavorSupportTest {
    ...
    @Test
    void testEnsureLocale() {
        assertEquals(Locale.US, CaseFlavorSupport.ensure(null));
    }
    ...
    @Test
    void testToLispCaseWithDefaultLocale() {
    ...
    @Test
    void testToKebabCaseWithLocale() {
    ...
    @Test
    void testToSnakeCaseWithDefaultLLocale() {
