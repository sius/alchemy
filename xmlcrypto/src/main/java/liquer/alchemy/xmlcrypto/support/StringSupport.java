...
public final class StringSupport {
	...
	private static final String UNRESERVED_RFC3986 = ALPHANUM + "_-~.";
	private static final String RESERVED = PUNCT + "?/[]@";
	private static final String EMPTY = "";
	
	
	private static final String OTHER_ISO_CONTROL = String.valueOf(
		new char[] {
			'\u0000', '\u0001','\u0002','\u0003','\u0004','\u0005','\u0006','\u0007',
			'\u0008', '\u0009', '\n'   ,'\u000B','\u000C','\r'    ,'\u000E','\u000F',
			'\u0010', '\u0011','\u0012','\u0013','\u0014','\u0015','\u0016','\u0017',
    ...
    public static String joinDistinct(String delimiter, Object... values) {
        return Stream.of(values).map(x -> trim(x.toString(), delimiter)).filter(StringSupport::notNullEmptyOrBlank)
